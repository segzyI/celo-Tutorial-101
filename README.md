...
In this tutorial, you will build a rental service smart contract on the Celo blockchain network. This will enable users to spend Celo on transactions.
...
Examples of rental services companies include Airbnb, Enterprise Rent-A-Car, Zipcar among many others.
...
Name it RentalServices.sol

If you don't know how to create a file in Remix IDE, follow this link.
...
Before we can test our smart contract, we need to compile and deploy it. when you are done compiling and deploying your smart contract, test some of the functions and variables

In deploy and run transactions tabs:

Navigate to deployed contracts section, you will see your smart contract there

Expand your contracts. You will see buttons for functions and state variables 

Test rentOutProperty Function

Follow the steps below to test the rentOutProperty function

Expand the input fields next to the rentOutProperty button. 

Enter the appropriate parameter in the input field provided.
...
Expand the input fields next to the rentProperty button. 

Enter the appropriate parameter in the input field provided.

Navigate to the value field. Enter an amount corresponding to difference between checkOutDate and CheckInDate.
...
Expand the input fields next to the bookings button. 
...
Expand the input fields next to the markPropertyAsInactive button. 
